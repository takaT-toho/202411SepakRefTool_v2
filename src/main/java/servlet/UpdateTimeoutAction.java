...
public class UpdateTimeoutAction {

    public UpdateTimeoutAction() {
    }
    ...
    public boolean execute(PointJSON pointJson) {
        ...
        try {
            ...
            if (type == null || type.equals("") || !type.equals("TIMEOUT")) {
            ...
            boolean res = logic.updateTimeout(Integer.parseInt(gameId), firstDetail, isAreguGot);
            if (res == false) {
