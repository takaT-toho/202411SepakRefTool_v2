...
// 上のコードを基に、MySQLのテーブル作成SQL文を作成してください。
// ただし、テーブル名はgameDetail、主キーはgameId、それ以外のカラムは上のコードを参考にしてください。
// また、カラムの型は適切なものを選んでください。
// コメントで書いてください。
...
// デモデータでINSERT文を作成してください。
// gameIdは101、それ以外のカラムは適当な値を入れてください。
// コメントで書いてください。
